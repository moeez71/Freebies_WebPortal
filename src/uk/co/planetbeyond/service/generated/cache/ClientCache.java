...
public final class ClientCache 
{
	...
	/**
	 * Maximum number of ClientBean objects that may be in the cache.
	 */
	private int maxCacheSize = 80;

	/**
	 * The number of ClientBean objects currently in the cache.
	 */
	 ...
	 * objects that refer to the actual ClientBean.
	 */
	...
	*/
	...
	/**
	 * A ClientBean object is passed to this method for addition to the cache.
	 */
	public void addClient(ClientBean bean) 
	{
		synchronized(updateLock)
		{ 
			Integer id = bean.getClientId();
			if (null == cache.get(id)) 
			{
				...
				else 
				{
					...
					if (maxCacheSize < currentCacheSize) 
					{
						...
						cache.remove(newLink.bean.getClientId());
						lru.next = null;
					} 
					else 
					{
	...
	/**
	 * Return the ClientBean associated with the given key.
	 */
	public ClientBean fetchClient(Integer id) 
	{
		...
		if (null == foundLink) 
		{
			...
			try 
			{
				bean = ClientManagerImpl.getInstance().loadByPrimaryKey(id);
			} 
	...
	/**
	 * Updates ClientBean object in the cache.
	 */
	...
	/**
	 * Returns true if ClientBean object is in the cache. FALSE otherwise
	 */
	public boolean isClientInCache(ClientBean bean) 
	{
		Integer id = bean.getClientId();
